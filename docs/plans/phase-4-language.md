# Phase 4 - the khem language (only what the kernel needs)
...
Phase 4 lands on a 3D kernel: the port (phase 2, ADR-0013)
...
.kem descriptions in, a WorldState of atoms and bonds out. Phase 4
